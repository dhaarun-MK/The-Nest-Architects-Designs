...
let ContactMessage = class ContactMessage {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, email: { required: true, type: () => String }, phone: { required: true, type: () => String }, subject: { required: true, type: () => String }, message: { required: true, type: () => String }, is_read: { required: true, type: () => Boolean }, created_at: { required: true, type: () => Date } };
    }
};
...
], ContactMessage.prototype, "is_read", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)(),
    __metadata("design:type", Date)
], ContactMessage.prototype, "created_at", void 0);
