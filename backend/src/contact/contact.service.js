...
let ContactService = class ContactService {
    ...
    async remove(id) { await this.repo.delete(id); return { message: 'Message deleted' }; }
    async markRead(id) { await this.repo.update(id, { is_read: true }); return { message: 'Marked as read' }; }
