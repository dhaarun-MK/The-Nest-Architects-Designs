...
class CreateContactDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, email: { required: true, type: () => String }, phone: { required: false, type: () => String }, subject: { required: true, type: () => String }, message: { required: true, type: () => String } };
    }
}
